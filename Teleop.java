...
public class Teleop extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        // Reset elevator and hook motor encoders
        ...
        // Set hook motor direction
        hook_motor.setDirection(DcMotor.Direction.REVERSE);
        ...
        while (opModeIsActive()) {
            ...
            // Get encoder position of the elevator and hook
            elevator_position = Math.abs(elevator.getCurrentPosition());
            hook_position = Math.abs(hook_motor.getCurrentPosition()); 
            
            // Elevator is going up
            if ((this.gamepad2.left_stick_y < 0) && (elevator_position < 4500)) {
                arm_speed = 0.5;
            }
            ...
            //if ((hook_position >= 11000 && this.gamepad2.right_stick_y < 0) || 
               //(hook_position <= 0 && this.gamepad2.right_stick_y > 0)) {
            //    hook_speed = 0;
            //} else {
                hook_speed = 0.75;
            //}
 
            // Set power to elevator and hook motor
            ...
            if (elevator_position > 2000) {
                left_servo_position = .00012 * (elevator_position - 2000);
                right_servo_position = 1 - (.00012 * (elevator_position - 2000));
            }
            ...
            telemetry.addData("gamepad", this.gamepad2.right_stick_y);
            telemetry.addData("speed", hook_speed);
            telemetry.addData("pos", hook_position);
            telemetry.update();
        }
    }
